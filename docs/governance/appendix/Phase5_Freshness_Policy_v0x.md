...
- Change Policy:
  ...
  - MUST NOT weaken or contradict the Core Policy Bundle

> **Layer Invariant**
> Where ambiguity, missing thresholds, misconfiguration, or unclear ownership exists,
> the safest applicable interpretation from the Core Policy Bundle SHALL apply.
...
### 1.1 Purpose
This document defines **how freshness states are interpreted, escalated, and enforced operationally**
...
- Eligibility remains subject to A4/A5 and the Core Policy Bundle
