...
All examples under docs/governance/p5/examples/ are NON-NORMATIVE reference artifacts only and SHALL NOT be treated as binding policy, canonical requirements, or conformance criteria.
