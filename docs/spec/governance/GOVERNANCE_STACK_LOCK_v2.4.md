...
as stepwise decision flows including triggers,
decision authorities, required evidence, and outcomes.
...
using controlled fault injection or chaos experiments,
with results recorded as evidence.
...
Council vote records (participants, votes, rationale)
MUST be captured as evidence.
...
Council decision records MUST be captured as evidence.
...
to assemble coherent evidence chains across logs,
metrics, attestations, and external signals.
...
Governance SHOULD track MTTD, MTTR, SLA adherence, verification coverage.

---

# 22. Interoperability

Interoperability protocols SHOULD include version negotiation
...
under formal amendment process.
