...
presenting risks and expected outcomes for decisions.
...
Evidence integrity SHOULD be reinforced using multi-layer storage
including WORM archives and independent stores.

Archive strategies SHOULD include migration to post-quantum
...
Governance SHOULD track operational metrics including SLA performance.
