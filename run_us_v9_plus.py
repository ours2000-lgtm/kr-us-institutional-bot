# ======================================================================
# run_us_v9_plus.py — 미국장 자동매매 엔진 V9 PLUS (Alpaca Broker 버전)
# ======================================================================
...
from broker_alpaca_v9 import AlpacaBrokerV9  # ★ 여기가 핵심 변경점
...
safe_log("============================================================")
safe_log("    🇺🇸 미국장 자동매매 V9 PLUS (AlpacaBroker) 시작")
safe_log("============================================================")

# -----------------------------
# Alpaca Broker 연결 (REAL / PAPER 자동)
# -----------------------------
try:
    broker = AlpacaBrokerV9(
        api_key=CONFIG["BROKER"]["US"]["key"],
        secret=CONFIG["BROKER"]["US"]["secret"],
        paper=CONFIG["BROKER"]["US"]["paper"]
    )
except Exception as e:
    safe_log(f"[BROKER ERROR] Alpaca 연결 실패: {e}")
    raise SystemExit("[ERROR] Alpaca Broker 초기화 실패. 종료됨.")
...
safe_log("[SYSTEM] 미국 V9 PLUS 초기화 완료 (Alpaca 연결 OK)")
