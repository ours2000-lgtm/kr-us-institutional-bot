...
주의:
- volume 필드는 InputSnapshot에 포함되어 있으나,
  V1.8에서는 직접적인 risk_score 계산에는 사용하지 않음 (future use).
"""
...
class RiskEngineV18:
    ...
    - 파라미터화된 risk score & level 분류
    """

    def __init__(
        self,
        engine_version: str = "V1.8",
        market: str = "KR",
        *,
    ...
    def _validate_input(self, snapshot: InputSnapshot, events: List[Event]) -> None:
        ...
        - volume은 V1.8에서 optional (future use)
        - 간단한 범위 체크 포함
        """
...
if __name__ == "__main__":
    ...
    snapshot: InputSnapshot = {
        ...
        "volatility": 0.02,
        "liquidity": 0.9,
        "timestamp": RiskEngineV18._now_iso(),
        "raw": {},
    }
