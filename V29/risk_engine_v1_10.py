"""
risk_engine_v1_10.py

RiskEngine V1.10 — Final Baseline for V1 Line (Stateless + Typed + Exchange-Grade)
...
- 입력단 NaN(volatility/liquidity) 감지 이벤트 (nan_input)
...
이 버전은 V1.x 라인의 최종 baseline으로, 이후 V2(다중 리스크 소스, 포트폴리오/전략 레벨 통합)의 기반이 된다.
"""
...
class RiskEngineV110:
    ...
    def _validate_input(self, snapshot: InputSnapshot, events: List[Event]) -> None:
        ...
        - volume은 V1.10에서 optional (future use)
        - 간단한 타입 및 범위 체크 포함
        """
...
if __name__ == "__main__":
    ...
    snapshot_ok: InputSnapshot = {
        ...
        "volatility": 0.02,
        "liquidity": 0.9,
        "timestamp": RiskEngineV110._now_iso(),
        "raw": {},
    }
