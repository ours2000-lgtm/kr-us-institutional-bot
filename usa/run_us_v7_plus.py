# =============================================================
# run_us_v7_plus.py — 미국 자동매매 엔진 (V7 PLUS)
# =============================================================
...
def main():
    ...
    signal_engine = USSignal_V7Plus(logger=logger)        # ★ 수정
    executor = USExecutorV7Plus(logger=logger, mode="SIM")
    portfolio = USPortfolio_V7Plus(logger=logger)         # ★ 수정
    ...
    while True:
        try:
            ...
            # 2) 시장 레짐 업데이트
            # ----------------------------------------------------
            regime = regime_engine.update_and_classify(market_data)
