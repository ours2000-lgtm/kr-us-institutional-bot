@echo off
chcp 65001 >nul
echo [US_SHORTCUT] 미국 자동매매 V5 PLUS 바로가기 생성...

set TARGET_PY="E:\KR_US_INSTITUTIONAL_BOT\usa\run_us_v5_plus.py"
set SHORTCUT_PATH="%USERPROFILE%\Desktop\미국 자동매매 V5 PLUS.lnk"
...
echo 완료! 바탕화면에 '미국 자동매매 V5 PLUS' 바로가기가 생성되었습니다.
pause
